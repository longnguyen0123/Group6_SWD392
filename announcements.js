...
/**
 * Fetches all announcements, sorted by creation date.
 * Corresponds to: :AnnouncementService -> :DatabaseSystem: (Query for announcement list)
 * @returns {Promise<Array>} A promise that resolves to an array of announcements.
 */
 ...
 * Corresponds to: :AnnouncementService -> :DatabaseSystem: (Store the new announcement)
 * @param {object} announcementData - The data for the new announcement (title, content, visible).
 * @returns {Promise<object>} A promise that resolves to the created announcement data.
 */
